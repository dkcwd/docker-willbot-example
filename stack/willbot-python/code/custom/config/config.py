...
# test if can get redis address from docker environment variable
try:
   os.environ["WILLBOT_REDIS_PORT_6379_TCP_ADDR"]
except KeyError:
   print "Please set the environment variable WILLBOT_REDIS_PORT_6379_TCP_ADDR"
   sys.exit(1)

# redis url based on environment variable
REDIS_URL = 'redis://' + os.environ["WILLBOT_REDIS_PORT_6379_TCP_ADDR"] + ':6379'
...
# rooms
ROOMS = ['MyBotTest',]
DEFAULT_ROOM = 'MyBotTest'

# log level
LOGLEVEL = "DEBUG"

# credentials examples below, put the right details in and uncomment them:
# USERNAME = 'the-correct-user-name@chat.hipchat.com'
# PASSWORD = 'the-correct-password'
# V2_TOKEN = 'the-correct-token'

# hipchat server details
HIPCHAT_SERVER = ''
HTTPSERVER_PORT = ''

# templates folder
TEMPLATE_DIRS = [
  os.path.abspath("/willbot/templates")
]